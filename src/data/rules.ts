...
export const REQUIRED_COVERAGE_GROUPS = [
  {
    ...
    fulfilledByClasses: ['mage', 'sage', 'darkMage', 'sorcerer'],
  ...
  },
  {
    ...
    label: 'Cleric',
    hint: 'Healing',
    fulfilledByClasses: ['curate', 'cleric', 'bishop'],
  ...
  },
  {
    id: 'ranged',
    label: 'Archer',
    hint: 'Flying counterplay',
    fulfilledByClasses: ['archer', 'sniper', 'hunter', 'horseman', 'ballistician'],
  ...
  },
  {
    ...
    fulfilledByClasses: ['cavalier', 'paladin', 'pegasusKnight'],
    fulfilledByWeapons: [],
    fulfilledByMovements: [],
    bonus: 1,
  },
