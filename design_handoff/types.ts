...
export type PhaseKey =
  ...
  | 'mid' // Midgame
  | 'midlate' // Early Lategame
  | 'late' // Lategame

export const PHASE_ORDER: PhaseKey[] = ['early', 'earlymid', 'mid', 'midlate', 'late']
...
export type RoleTag = 'lord' | 'mounted' | 'armor' | 'flier' | 'healer' | 'utility' | 'copy' | 'defensive'
...
export interface CardEffect {
   ...
   */
  resolve?: (ctx: { self: Character; owner: PlayerStanding; state: GameState }) => Partial<PhaseStats> | void
}
